...
|                |                                                    |                                                       |
| -------------- | -------------------------------------------------- | ----------------------------------------------------- |
| **ChillHub**   | [launcher.samoy.love](https://launcher.samoy.love) | лаунчер игр: сайт, раздача сборок, обновление клиента |
| **Snakes**     | [snakes.samoy.love](https://snakes.samoy.love)     | мультиплеерный захват территории                      |
| **MetroKit**   | [metro.samoy.love](https://metro.samoy.love)       | офлайн-PWA со схемой московского метро                |
| **samoy.love** | [samoy.love](https://samoy.love)                   | личная страница и витрина проектов                    |
...
flowchart LR
    subgraph host["один хост"]
        svc["сервисы<br/>ChillHub · Snakes<br/>MetroKit · samoy.love"]
...
Историю проверок можно читать, не заходя на сайт: сторож коммитит её прямо в
репозиторий, в `data/`.
